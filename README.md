...
This is the markdown for the example analysis presented in the [PTOS Topic Modeling](https://doi.org/10.23668/psycharchives.8382) lecture. Here, a topic modeling workflow is presented using song lyrics as an example.
